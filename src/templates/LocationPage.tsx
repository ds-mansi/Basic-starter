  ...
  console.log(_site.c_headerlinks);
    return (
      ...
      <div style={{fontSize:"30px",textAlign:"center",backgroundColor:"#E0D0F1",color:"#281845"}}>{name}</div>
        ...
        <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal"style={{backgroundColor:"#F9DDDD"}}>
         ...
         <div className="rounded overflow-hidden shadow-lg">
          ...
          <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b" style={{backgroundColor:"#F9DDDD"}}>
          <h3 style={{fontWeight:"bold",paddingTop:"20px"}}>{"HOURS:"}</h3> 
