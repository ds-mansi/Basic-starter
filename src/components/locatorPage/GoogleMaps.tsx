...
const builtInCssClasses: Readonly<GoogleMapsCssClasses> = {
  googleMapsContainer: 'w-82  h-48 md:h-96 lg:h-[calc(100vh_-_0px)] xl:h-[calc(100vh_-_0px)]  top-0   2xl:h-[calc(100vh_-_0px)] order-1 lg:order-none z-[99]'
};
...
function Infowindow(i:Number,result:any):void{      
    const MarkerContent=         
        ...
        <br/>
        {result.rawData.address.region}
        <br/>
        <span style={{backgroundColor:"#657383",color:"white",width:"45%",border:"black"}}>
